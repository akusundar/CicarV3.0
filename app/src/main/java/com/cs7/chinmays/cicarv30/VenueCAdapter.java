...
public class VenueCAdapter extends CursorAdapter{


    public VenueCAdapter(Context context, Cursor c)
    {
...

    {
        ...
        String name = cursor.getString(cursor.getColumnIndexOrThrow(EventEntry.COLUMN_VENUE_NAME));
        int cost = cursor.getInt(cursor.getColumnIndexOrThrow(EventEntry.COLUMN_VENUE_COST));
