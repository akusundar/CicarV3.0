...
public class ViewVenue extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {

    private static final int EVENT_LOADER =0;
    VenueCAdapter mCursorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView venuelistview = (ListView) findViewById(R.id.venue_list_view);


        mCursorAdapter = new VenueCAdapter(this,null);
        ...
        venuelistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                Intent i = new Intent(ViewVenue.this,CreateVenue.class);


                Uri currentEventUri = ContentUris.withAppendedId(EventEntry.CONTENT_URI2,id);
...
// Insert the new row, returning the primary key value of the new row
        ...
        getContentResolver().insert(EventEntry.CONTENT_URI2,values);
    }

    private void deleteAllEvents() {
        int rowsDeleted = getContentResolver().delete(EventEntry.CONTENT_URI2, null, null);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, EventEntry.CONTENT_URI2,projection,null,null,null);
